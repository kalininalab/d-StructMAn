...
build_mmseqs_index() {
    (cd /usr/structman_library/sources/StructMAn/lib/base/blast_db/; mmseqs createindex /usr/structman_library/sources/StructMAn/lib/base/blast_db/pdbba_mmseqs2 /usr/structman_library/sources/StructMAn/lib/base/blast_db/tmp/)
