...
--
-- Host: bioinfodb:3306
-- Generation Time: Nov 27, 2018 at 03:25 PM
...
--
-- Database: `struct_man_db_7`
--
CREATE DATABASE IF NOT EXISTS `struct_man_db_7` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `struct_man_db_7`;
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=2497510 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=85599 ;
...
CREATE TABLE IF NOT EXISTS `GO_Term` (
  ...
  UNIQUE KEY `Name` (`Id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=28399 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=16524 ;
...
CREATE TABLE IF NOT EXISTS `Mutation` (
  ...
  KEY `Gene` (`Gene`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=33955140 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=2376 ;
...
CREATE TABLE IF NOT EXISTS `Residue` (
  ...
  KEY `Structure` (`Structure`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=27387507 ;
...
DROP TABLE IF EXISTS `RS_Gene_GO_Term`;
...
DROP TABLE IF EXISTS `RS_Gene_Pathway`;
...
DROP TABLE IF EXISTS `RS_Gene_Session`;
...
DROP TABLE IF EXISTS `RS_Ligand_Structure`;
...
DROP TABLE IF EXISTS `RS_Mutation_Session`;
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=102172 ;
...
ALTER TABLE `RS_Mutation_Residue`
  ADD CONSTRAINT `RS_Mutation_Residue_ibfk_1` FOREIGN KEY (`Residue`) REFERENCES `Residue` (`Residue_Id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `RS_Mutation_Residue_ibfk_2` FOREIGN KEY (`Mutation`) REFERENCES `Mutation` (`Mutation_Id`) ON DELETE CASCADE ON UPDATE CASCADE;
