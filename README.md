...
- **resources:** Useful resources such as local PDB or other executables required by StructMAn should be put here before starting the container. For more read [here](https://github.com/sanjaysrikakulam/structman/wiki/Local-resources)
